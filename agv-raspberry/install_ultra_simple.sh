...
echo ""
echo "📋 MANUALMENTE, execute como usuário vcp2909:"
echo ""
echo "1. Acesse como usuário vcp2909:"
echo "   su - vcp2909"
echo ""
...
echo ""
echo "8. Execute próximos passos automaticamente:"
echo "   python next_steps.py"
...
echo "   sudo usermod -a -G video vcp2909"
echo ""
echo "🔌 ESP32 (se usar):"
...
echo ""
echo "🎯 PRÓXIMOS PASSOS APÓS CONFIGURAÇÃO:"
echo "   1. Acesse interface web: http://SEU_PC_IP:5000"
echo "   2. Use o app mobile para controle"
echo "   3. Monitore logs em tempo real"
echo "   4. Teste funcionalidades do sistema"
echo ""
